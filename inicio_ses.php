			...
			<div class="left">
				<div class="contact">
					<form action="php/login.php" method="POST">
						...
						<input name="correo" type="text" placeholder="Ingrese un correo electrónico">
						<input name="contrasena" type="password" placeholder="Ingrese una contraseña">
						<button class="submit">Ingresar</button>
						<p style="text-align: center;"> <a href="registro.php"> ¿No tienes cuenta? Registráte ahora </a></p>
					</form>
				</div>
			</div>
			<div class="right">
